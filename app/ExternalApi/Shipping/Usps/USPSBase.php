...
namespace App\ExternalApi\Shipping\Usps;
...
abstract class USPSBase
{
    ...
    const LIVE_API_URL = 'https://secure.shippingapis.com/ShippingAPITest.dll';
    ...
    public function __construct($username = '')
    {
         ...
         */
        $this->testMode = env('USPS_PRODUCTION');
    }
    ...
    {
        $endPoint = $this->testMode ? self::TEST_API_URL : self::LIVE_API_URL;
        return $endPoint;
    }
