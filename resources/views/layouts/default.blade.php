...
<head>
	...
	<title>By Mundi - @yield('title')</title>
...
<body>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			...
			<div id="mobile_only_nav" class="mobile-only-nav pull-right">
				<ul class="nav navbar-right top-nav pull-right">
					<li>
						<a href="#" class="">
							<i class="fa fa-fw fa-dollar"></i> <span id="dollar_value"></span>
						</a>
					</li>
					@if (auth()->user()->userable_type == 'App\Models\Customer')
						<li>
							<a href="{{ route('customer.faqs.index') }}">FAQ</a>
						</li>
					@endif
					{{-- <li>
					...
					<li class="dropdown auth-drp">
						...
						<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
							<li>
								<a href="#"><i class="zmdi zmdi-account"></i><span>Meus dados</span></a>
							</li>
							{{-- <li>
			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<div class="user-profile text-center">
						...
						<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
							{{-- <li>
								<a href="{{ route('dashboard') }}"><i class="zmdi zmdi-account"></i><span>Minha conta</span></a>
							</li>
							<li>
							...
							{{-- <li class="divider"></li> --}}
							<li>
								<a href="{{ route('sair') }}"><i class="zmdi zmdi-power"></i><span>Logout</span></a>
							</li>
						</ul>
                    </div>
                </li>
	...
	<script src="{{ asset('js/dollar.js') }}"></script>
